...
def combine_videos(data_dir, selected_files, output_file):
    ...
    output_width = gaze_width + neon_width + depth_width + color_width
    ...
    for frame_idx in range(int(total_frames)):
        ...
        combined_frame[:, gaze_width+neon_width:gaze_width+neon_width+depth_width] = depth_frame
        combined_frame[:, gaze_width+neon_width+depth_width:] = color_frame
