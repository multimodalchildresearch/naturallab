...
class KalmanPersonTracker(BaseTracker):
    ...
    def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # A detector cadence skip is not evidence that a person disappeared.
        # Return Kalman predictions without aging or deleting tracks; their age
        # is updated only on frames where detection actually ran.
        if intentional_skip:
            active_tracks = [
                track
                for track in self.tracks
