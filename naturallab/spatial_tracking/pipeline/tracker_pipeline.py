...
class TrackerPipeline:
    ...
    def __init__(
        ...
        """
        self.logger = logging.getLogger("naturallab.spatial_tracking.TrackerPipeline")
        self.modules = modules
        self.provenance = deepcopy(dict(provenance or {}))
    ...
    def process_frame(self, frame: np.ndarray, frame_idx: int = 0) -> Tuple[bool, np.ndarray, Dict[str, Any]]:
        ...
        if self.provenance:
            data['pipeline_provenance'] = deepcopy(self.provenance)
